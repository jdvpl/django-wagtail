# Generated by Django 3.1.13 on 2021-12-16 23:27
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('servicio_ciudadano', '0060_auto_20211216_1819'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='history',
            field=wagtail.core.fields.RichTextField(blank=True, help_text='Historico de cronogramas', null=True, verbose_name='Historico de cronogramas'),
        ),
        migrations.AddField(
            model_name='eventospage',
            name='history_icon',
            field=models.ForeignKey(help_text='Icono', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='wagtailsvg.svg', verbose_name='Icono'),
        ),
        migrations.AddField(
            model_name='eventospage',
            name='second_links',
