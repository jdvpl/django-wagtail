...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0034_auto_20211128_1125'),
    ]

    operations = [
        migrations.CreateModel(
            name='HidrocarburosPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Hidrocarburos', max_length=254, verbose_name='Título de la sección')),
                ...
                ('title_pbi', models.CharField(default='Precios, demanda y oferta', max_length=254, verbose_name='Título de la sección')),
                ('intro_pbi', wagtail.core.fields.RichTextField(blank=True, help_text='Introducción de la sección', null=True, verbose_name='Introducción')),
