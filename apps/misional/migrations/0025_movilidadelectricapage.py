# Generated by Django 3.1.13 on 2021-11-24 23:44
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0024_medidoresinteligentespage'),
    ]

    operations = [
        migrations.CreateModel(
            name='MovilidadElectricaPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Movilidad Eléctrica', max_length=254, verbose_name='Título de la sección')),
