# Generated by Django 3.1.13 on 2021-12-04 21:20
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0073_auto_20211204_1610'),
    ]

    operations = [
        migrations.CreateModel(
            name='NuevosHogaresIndexPage',
            fields=[
        ...
        migrations.CreateModel(
            name='NuevosHogaresServicioEnergiaElectricaPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default=' Construcción de proyectos eólicos en La Guajira', max_length=254, verbose_name='Título de la sección')),
        ...
        migrations.CreateModel(
            name='NuevosHogaresSectorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='nuevoshogares_sector_relationship', to='misional.nuevoshogarespage')),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sector_nuevoshogares_relationship', to='common.sector')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='NuevosHogaresPageTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_items', to='misional.nuevoshogarespage')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='misional_nuevoshogarespagetag_items', to='taggit.tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='nuevoshogarespage',
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='misional.NuevosHogaresPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='NuevosHogaresAutorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='autor_nuevoshogares_relationship', to='common.autor')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='nuevoshogares_autor_relationship', to='misional.nuevoshogarespage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
