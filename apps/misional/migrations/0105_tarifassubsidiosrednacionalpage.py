# Generated by Django 3.1.13 on 2021-12-24 22:28
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0104_preguntasfrecuentesreglamentostecnicossectorenergiaelectricapage'),
    ]

    operations = [
        migrations.CreateModel(
            name='TarifasSubsidiosRedNacionalPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Acceso a energía', max_length=254, verbose_name='Título de la sección')),
