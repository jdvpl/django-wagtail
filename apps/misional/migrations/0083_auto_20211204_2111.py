# Generated by Django 3.1.13 on 2021-12-05 02:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0082_auto_20211204_2059'),
    ]

    operations = [
        migrations.CreateModel(
            name='DiversificacionIndexPage',
            fields=[
        ...
        migrations.AlterField(
            model_name='reglamentacionleypage',
            name='intro_title',
            field=models.CharField(default=' Reglamentación de la Ley de Transición Energética', max_length=254, verbose_name='Título de la sección'),
        ),
        migrations.CreateModel(
            name='DiversificacionSectorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='diversificacion_sector_relationship', to='misional.diversificacionpage')),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sector_diversificacion_relationship', to='common.sector')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='DiversificacionPageTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_items', to='misional.diversificacionpage')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='misional_diversificacionpagetag_items', to='taggit.tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='diversificacionpage',
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='misional.DiversificacionPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='DiversificacionMineraPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default=' Reglamentación de la Ley de Transición Energética', max_length=254, verbose_name='Título de la sección')),
        ...
        migrations.CreateModel(
            name='DiversificacionAutorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='autor_diversificacion_relationship', to='common.autor')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='diversificacion_autor_relationship', to='misional.diversificacionpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
