# Generated by Django 3.1.13 on 2021-12-02 03:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('misional', '0052_auto_20211201_2149'),
    ]

    operations = [
        migrations.RemoveField(
            model_name='funcionamientosectorpage',
            name='alt_text_second',
        ),
        migrations.RemoveField(
            model_name='funcionamientosectorpage',
            name='featured_link',
        ...
        migrations.AddField(
            model_name='funcionamientosectorpage',
            name='block_list',
            field=wagtail.core.fields.StreamField([('Tabs', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock(help_text='Título del elemento', label='Título', required=True)), ('description', wagtail.core.blocks.RichTextBlock(help_text='Descripción', label='Descripción', required=True)), ('icono', wagtailsvg.blocks.SvgChooserBlock(help_text='Icono del elemento que será mostrado al publico, solo imágenes en formato SVG.', label='Icono', required=True)), ('align', wagtail.core.blocks.ChoiceBlock(choices=[('true', 'Izquierda')], help_text='Si esta opción esta activa, la icono se alineara a la izquierda, por defecto se alineará a la derecha.', label='Alinear icono a la izquierda', required=False)), ('page', wagtail.core.blocks.PageChooserBlock(help_text='Complete este campo si desea enlazar este elemento con una página local', label='Link a página local', required=False)), ('external_url', wagtail.core.blocks.URLBlock(help_text='Complete este campo si desea enlazar este elemento con una página externa. Si este campo está completo, no se tendrá en cuenta el link a página local', label='Link a página externa', required=False))]))], blank=True, verbose_name='Bloques'),
        ),
        migrations.AddField(
            model_name='funcionamientosectorpage',
            name='link_list',
