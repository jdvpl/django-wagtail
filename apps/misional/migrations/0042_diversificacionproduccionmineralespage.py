# Generated by Django 3.1.13 on 2021-12-01 02:38
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0041_auto_20211130_2109'),
    ]

    operations = [
        migrations.CreateModel(
            name='DiversificacionProduccionMineralesPage',
            fields=[
                ...
                ('cards_list', wagtail.core.fields.StreamField([('Agenda', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.CharBlock(help_text='Titulo del mecanismo de participación', label='Titulo', required=True)), ('description', wagtail.core.blocks.TextBlock(help_text='Descripción del mecanismo de participación', label='Descripción del elemento', required=True)), ('document', wagtail.documents.blocks.DocumentChooserBlock(help_text='Seleccione un documento', label='Documento', required=False))]))], blank=True, verbose_name='Agendas')),
