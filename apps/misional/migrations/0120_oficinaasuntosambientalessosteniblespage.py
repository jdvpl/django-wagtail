# Generated by Django 3.1.13 on 2022-03-16 01:53
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0119_remove_gestionsocialambientalpage_sostenib_list_title'),
    ]

    operations = [
        migrations.CreateModel(
            name='OficinaAsuntosAmbientalesSosteniblesPage',
            fields=[
                ...
                ('third_title', models.CharField(default='Funciones', max_length=254, verbose_name='Título de la sección')),
                ('third_text', wagtail.core.fields.RichTextField(blank=True, help_text='Texto de de la sección', null=True, verbose_name='Historia')),
