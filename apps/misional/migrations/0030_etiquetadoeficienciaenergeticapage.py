# Generated by Django 3.1.13 on 2021-11-25 12:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0029_auto_20211125_0634'),
    ]

    operations = [
        migrations.CreateModel(
            name='EtiquetadoEficienciaEnergeticaPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Etiquetado de eficiencia energética', max_length=254, verbose_name='Título de la sección')),
                ...
                ('title_page', models.CharField(default='etiquetaenergetica.gov.co', max_length=254, verbose_name='Título del boton')),
                ('link_page', models.URLField(blank=True, help_text='Link etiquetaenergetica.gov.co', verbose_name='Link etiquetaenergetica.gov.coI')),
