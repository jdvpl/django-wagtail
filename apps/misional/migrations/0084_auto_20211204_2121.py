# Generated by Django 3.1.13 on 2021-12-05 02:21
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0083_auto_20211204_2111'),
    ]

    operations = [
        migrations.CreateModel(
            name='SubastasEnergiasIndexPage',
            fields=[
        ...
        migrations.AlterField(
            model_name='diversificacionminerapage',
            name='intro_title',
            field=models.CharField(default='Diversificación minera como aliada de la transición energética', max_length=254, verbose_name='Título de la sección'),
        ),
        migrations.CreateModel(
            name='SubastasEnergiasSectorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='subastasenergias_sector_relationship', to='misional.subastasenergiaspage')),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sector_subastasenergias_relationship', to='common.sector')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='SubastasEnergiasRenovablesPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Subastas de energías renovables', max_length=254, verbose_name='Título de la sección')),
        ...
        migrations.CreateModel(
            name='SubastasEnergiasPageTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_items', to='misional.subastasenergiaspage')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='misional_subastasenergiaspagetag_items', to='taggit.tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='subastasenergiaspage',
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='misional.SubastasEnergiasPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='SubastasEnergiasAutorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='autor_subastasenergias_relationship', to='common.autor')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='subastasenergias_autor_relationship', to='misional.subastasenergiaspage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
