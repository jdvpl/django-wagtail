# Generated by Django 3.1.13 on 2021-12-04 22:17
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('misional', '0078_auto_20211204_1639'),
    ]

    operations = [
        migrations.CreateModel(
            name='ImplementacionIndexPage',
            fields=[
        ...
        migrations.CreateModel(
            name='ImplementacionSectorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='implementacion_sector_relationship', to='misional.implementacionpage')),
                ('sector', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sector_implementacion_relationship', to='common.sector')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
        ...
        migrations.CreateModel(
            name='ImplementacionPageTag',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tagged_items', to='misional.implementacionpage')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='misional_implementacionpagetag_items', to='taggit.tag')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='implementacionpage',
            name='tags',
            field=modelcluster.contrib.taggit.ClusterTaggableManager(help_text='A comma-separated list of tags.', through='misional.ImplementacionPageTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.CreateModel(
            name='ImplementacionMisionPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Implementación de la Misión de Transformación Energética', max_length=254, verbose_name='Título de la sección')),
        ...
        migrations.CreateModel(
            name='ImplementacionAutorRelationship',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sort_order', models.IntegerField(blank=True, editable=False, null=True)),
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='autor_implementacion_relationship', to='common.autor')),
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='implementacion_autor_relationship', to='misional.implementacionpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
