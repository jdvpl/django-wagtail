# Generated by Django 3.1.13 on 2022-02-27 05:04
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('repositorio_normativo', '0014_estructuraorganizacionalgruporegaliaspage'),
    ]

    operations = [
        migrations.CreateModel(
            name='InversionesSGRCovid19Page',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Inversiones SGR COVID 19', max_length=254, verbose_name='Título de la sección')),
