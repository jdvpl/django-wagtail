# Generated by Django 3.1.13 on 2022-03-01 22:16
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='NotificacionesAdministrativasPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Notificaciones Administrativas', max_length=254, verbose_name='Título de la sección')),
