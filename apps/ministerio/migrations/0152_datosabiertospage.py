# Generated by Django 3.1.13 on 2021-11-24 17:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ministerio', '0151_auto_20211124_1202'),
    ]

    operations = [
        migrations.CreateModel(
            name='DatosAbiertosPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Datos abiertos', max_length=254, verbose_name='Título de la sección')),
