# Generated by Django 3.1.13 on 2021-10-11 13:18
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('ministerio', '0066_auto_20211009_1544'),
    ]

    operations = [
        migrations.CreateModel(
            name='BajaEnajenacionBienesPage',
            fields=[
                ('page_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='wagtailcore.page')),
                ('intro_title', models.CharField(default='Ministerio', max_length=254, verbose_name='Título de la sección')),
